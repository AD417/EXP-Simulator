...
function tick() {
    ...
    // TODO: figure out where this should go. Probably can stay here, or
    // go to an extracted function.
    ...
    //photon colors
    // TODO: figure out where this should go. Probably should get extracted
    // to graphics.
    ...
    case 0:
        ...
        if (isNaN(game.autopr_goal[0])) game.autopr_goal[0] = game.pr_min;
    ...
    case 1:
        ...
        if (isNan(game.autopr_goal[1])) game.autopr_goal[1] = 1;
    ...
    case 2:
        ...
        if (isNaN(game.autopr_goal[2])) game.autopr_goal[2] = 1;
